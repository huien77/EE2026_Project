...
set_property PACKAGE_PIN T18 [get_ports U_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports U_button]
...
set_property PACKAGE_PIN U17 [get_ports D_button]						
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {JX[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[0]}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {JX[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[1]}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {JX[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[2]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {JX[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[3]}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {JX[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[4]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {JX[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[5]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {JX[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JX[6]}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {JX[7]}]					
